...
const CASE_STUDIES = {
  ...
  ltoreviewer: {
    ...
    eyebrow: 'Driver exam prep · 2025 · live',
    image: 'assets/bettergovfeaturesreviewer.webp',
    summary: 'An interactive exam-preparation platform for Philippine driver’s-license applicants, built to make review faster, clearer, and more mobile-friendly.',
    ...
    response: 'I built a responsive quiz engine with categorized questions, instant explanations, score summaries, signed quiz sessions, server-side rate limiting, and automated browser tests.',
